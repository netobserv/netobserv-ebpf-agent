...
require (
	...
	github.com/ovn-org/ovn-kubernetes/go-controller v0.0.0-20241112180943-9695576eab29
...
replace github.com/ovn-org/ovn-kubernetes/go-controller => ../ovn-kubernetes/go-controller
