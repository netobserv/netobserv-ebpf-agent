...
require (
	...
	github.com/netobserv/flowlogs-pipeline v1.7.0-community.0.20250203184813-8a3c8ec153e6
	github.com/netobserv/gopipes v0.3.0
	github.com/ovn-org/ovn-kubernetes/go-controller v0.0.0-20250204132549-6da0e6e96394
