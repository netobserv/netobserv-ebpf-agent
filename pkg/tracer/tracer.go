...
const (
	...
	netObservAgentProcess               = "netobserv_process"
...
func NewFlowFetcher(cfg *FlowFetcherConfig) (*FlowFetcher, error) {
	...
	if !cfg.UseEbpfManager {
		...
		maps2Name := []string{"aggregated_flows", "direct_flows", "dns_flows", "filter_map", "global_counters", "packet_record"}
	...
	// read events from ingress+egress ringbuffer
