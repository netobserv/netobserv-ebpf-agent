...
func loadObjectsOldKernelRtKernel(spec *cilium.CollectionSpec, pinDir string) (ebpf.BpfObjects, error) {
	...
	deletePrograms(spec, ebpf.BpfProgKfreeSkb, networkEventsMonitoringHook, ebpf.BpfProgTcpRcvKprobe, ebpf.BpfProgTcpRcvFentry)
...
func loadObjectsOldKernel(spec *cilium.CollectionSpec, pinDir string) (ebpf.BpfObjects, error) {
	...
	deletePrograms(spec, ebpf.BpfProgKfreeSkb, networkEventsMonitoringHook, ebpf.BpfProgTcpRcvFentry)
...
func loadObjectsRtKernel(spec *cilium.CollectionSpec, pinDir string) (ebpf.BpfObjects, error) {
	...
	deletePrograms(spec, ebpf.BpfProgKfreeSkb, networkEventsMonitoringHook, ebpf.BpfProgTcpRcvKprobe)
