...
type Record struct {
	...
	OvsMetadata            []string             `protobuf:"bytes,27,rep,name=ovs_metadata,json=ovsMetadata,proto3" json:"ovs_metadata,omitempty"`
}
...
func (x *Record) GetOvsMetadata() []string {
	if x != nil {
		return x.OvsMetadata
	}
	return nil
}
...
var file_proto_flow_proto_rawDesc = []byte{
	...
	0x22, 0xdf, 0x08, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x65,
	...
	0x21, 0x0a, 0x0c, 0x6f, 0x76, 0x73, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x1b, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x6f, 0x76, 0x73, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x22, 0x3c, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x17,
	...
	0x0d, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2a, 0x24, 0x0a, 0x09, 0x44,
	...
	0x01, 0x32, 0x3e, 0x0a, 0x09, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x31,
	0x0a, 0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x0f, 0x2e, 0x70, 0x62, 0x66, 0x6c, 0x6f, 0x77, 0x2e,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x1a, 0x16, 0x2e, 0x70, 0x62, 0x66, 0x6c, 0x6f, 0x77,
	0x2e, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22,
	0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x70, 0x62, 0x66, 0x6c, 0x6f, 0x77, 0x62, 0x06, 0x70,
...
func file_proto_flow_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_flow_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_flow_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_flow_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_flow_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_flow_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_proto_flow_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_proto_flow_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*IP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_flow_proto_msgTypes[7].Exporter = func(v any, i int) any {
